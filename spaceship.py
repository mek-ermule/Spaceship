...
def draw(canvas):
    ...
    # draw lives 
    canvas.draw_text("Lives", (50, 50), 30, "Green", "monospace")
    canvas.draw_text(str(lives), (75, 75), 30, "Green", "monospace")
 
    # draw score
    canvas.draw_text("Score", (WIDTH - 120, 50), 30, "Green", "monospace")
    canvas.draw_text(str(score), (WIDTH - 85, 75), 30, "Green", "monospace")
